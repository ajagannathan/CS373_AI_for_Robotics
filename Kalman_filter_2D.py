...
# %% [markdown]
# # Kalman Filter <br>
# The following program implements a multi-dimensional<br>
# Kalman filter algorithm to track the position and<br>
# velocity of a car moving in x axis<br>
...
# %% [markdown]
# ## output should be:
# x: [[3.9996664447958645], [0.9999998335552873]] <br>
# P: [[2.3318904241194827, 0.9991676099921091], [0.9991676099921067, 0.49950058263974184]] <br>
